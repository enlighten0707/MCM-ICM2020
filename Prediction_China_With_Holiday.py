...
import Prediction_China_Twice_Infected as Twice_Infected
...
#
#
#pd.DataFrame(StackProvince).to_csv('./Data/Stack_Province.csv')#1.22->2.4
...
China_Total_Twice_Infected=Twice_Infected.China_Total_Pre
Date_List_tmp=['1.22','1.27','2.1','2.6','2.11','2.16','2.21','2.26','3.2']
fig = plt.figure(41)
plt.plot(range(41), China_Total_Pre[2,52:93], 'o-',label='Without Mutation',markersize=5) #1.22->2.20
plt.plot(range(41), China_Total_Twice_Infected[2,52:93], 'o-',label='With Mutation',markersize=5)
plt.xticks(range(0,41,5),Date_List_tmp)
plt.xlabel('Date')
