...
fig = plt.figure(3)
plt.plot(range(len(Hubei_data.Confirmed)), Hubei_data.Confirmed, 'o-',label='Confirmed')
plt.plot(range(len(Hubei_data.Confirmed)), Hubei[2,50:66], '--',label='Prediction')
plt.legend(loc = 'best')
...
ShowProvince=['Beijing','Shanghai','Shandong','Jiangsu','Guangdong','Fujian','Hebei']
for j in range(34):
