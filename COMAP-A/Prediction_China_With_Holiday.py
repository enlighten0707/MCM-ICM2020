...
#    fig = plt.figure(4+j)
#    plt.plot(range(len(prov.Confirmed[j])),prov.Confirmed[j],'o-',label='True Value')
#    plt.plot(range(len(prov.Confirmed[j])),Place[2,52:66],'o-',label='Predictions') #1.22->2.4
...
#    plt.title(tit)
#    if Province== 'Shanghai':
#        plt.savefig('./figure/Shanghai_Validation.png')
#    else:
#        plt.savefig('./figure/Beijing_Validation.png')
...
#fig = plt.figure(43,figsize=(8.0,4.0))
#China_Total_Twice_Infected=Twice_Infection.China_Total_Pre
#Date_List_tmp=['1.22','1.27','2.1','2.6','2.11','2.16','2.21','2.26','3.2','3.7','3.12','3.17','3.22','3.27']
#plt.plot(range(66), China_Total_Pre[2,52:118], 'o-',label='Without Twice Infection',markersize=3) #1.22->2.20
#plt.plot(range(66), China_Total_Twice_Infected[2,52:118], 'o-',label='With Twice Infection',markersize=3)
#plt.xticks(range(0,66,5),Date_List_tmp)
#plt.xlabel('Date')
#plt.ylabel('Infected Cases')
#plt.legend(loc = 'upper left')
#plt.title('Prediction for Infected in China')
#plt.savefig('./figure/Prediction_With_Twice_Inf.png')
    
fig = plt.figure(44,figsize=(8.0,4.0))
China_Total_Returning=Returning.China_Total_Pre
Date_List_tmp=['1.22','1.27','2.1','2.6','2.11','2.16','2.21','2.26','3.2','3.7','3.12','3.17','3.22','3.27']
plt.plot(range(66), China_Total_Pre[2,52:118]/2, 'o-',label='Without Returning',markersize=3) #1.22->2.20
plt.plot(range(66), China_Total_Returning[2,52:118]/2, 'o-',label='With Returning',markersize=3)
plt.xticks(range(0,66,5),Date_List_tmp)
plt.xlabel('Date')
plt.ylabel('Infected Cases')
plt.legend(loc = 'upper left')
plt.title('Prediction for Infected in China')
plt.savefig('./figure/Prediction_With_Returning.png')